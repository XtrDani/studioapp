    ...
    <div class="container">
        <div class="booking-container">
            <div class="booking-header">
                <h2><i class="bi bi-calendar2-check-fill"></i> Programare</h2>
                <p class="mb-0">Programează-te în câțiva pași simpli!</p>
            </div>
            ...
            <div class="booking-steps position-relative">
                ...
                <div class="step" data-step="2">
                    ...
                    <div class="step-title">Serviciu</div>
                </div>
                ...
                <div class="step" data-step="4">
                    ...
                    <div class="step-title">Data & Ora</div>
                </div>
                <div class="step" data-step="5">
                    <div class="step-number">5</div>
                    <div class="step-title">Confirmare</div>
                </div>
            ...
            <div class="booking-content">
                ...
                <div class="booking-step active" id="step1">
                    <h3 class="mb-4">Alege o categorie</h3>
                ...
                <div class="booking-step" id="step2">
                    <h3 class="mb-4">Alege un serviciu</h3>
                ...
                <div class="booking-step" id="step3">
                    <h3 class="mb-4">Alege un membru al echipei</h3>
                ...
                <div class="booking-step" id="step4">
                    <h3 class="mb-4">Alege Data & Ora</h3>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Intervale orare disponibile</h5>
                ...
                <div class="booking-step" id="step5">
                    <h3 class="mb-4">Confirmă programarea</h3>
                    <div class="card">
                        <div class="card-header bg-light">
                            <h5 class="mb-0">Sumar programare</h5>
                        </div>
                        <div class="card-body">
                            <div class="summary-item">
                                <div class="row">
                                    <div class="col-md-4 text-muted">Categorie:</div>
                                    <div class="col-md-8" id="summary-category"></div>
                                </div>
                            </div>
                            <div class="summary-item">
                                <div class="row">
                                    <div class="col-md-4 text-muted">Serviciu:</div>
                                    <div class="col-md-8" id="summary-service"></div>
                                </div>
                            </div>
                            <div class="summary-item">
                                <div class="row">
                                    <div class="col-md-4 text-muted">Membru echipă:</div>
                                    <div class="col-md-8" id="summary-employee"></div>
                                </div>
                            </div>
                            <div class="summary-item">
                                <div class="row">
                                    <div class="col-md-4 text-muted">Data & Ora:</div>
                                    <div class="col-md-8" id="summary-datetime"></div>
                                </div>
                            </div>
                            <div class="summary-item">
                                <div class="row">
                                    <div class="col-md-4 text-muted">Durată:</div>
                                    <div class="col-md-8" id="summary-duration"></div>
                                </div>
                            </div>
                            <div class="summary-item">
                                <div class="row">
                                    <div class="col-md-4 text-muted">Preț:</div>
                                    <div class="col-md-8" id="summary-price"></div>
                                </div>
                            </div>

                            <div class="mt-4">
                                <h5>Informațiile tale</h5>
                                <form id="customer-info-form">
                                    @csrf
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label for="customer-name" class="form-label">Nume complet</label>
                                        ...
                                        <div class="col-12">
                                            <label for="customer-notes" class="form-label">Notițe (opțional)</label>
    ...
    <footer>
        <div class="container pb-2">
            <div class="row text-center">
                <span>TRADITIONAL HARMONY STUDIO</span>
            </div>
        </div>
    </footer>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title">Programare Confirmată!</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Închide"></button>
                </div>
                <div class="modal-body text-center p-4">
                    <i class="bi bi-check-circle text-success" style="font-size: 4rem;"></i>
                    <h4 class="mt-3">Vă mulțumim!</h4>
                    <p>Programarea dumneavoastră a fost realizată cu succes.</p>
                    <div class="alert alert-info mt-3">
                        <p class="mb-0">Un email de confirmare a fost trimis către adresa dumneavoastră.</p>
                    </div>
