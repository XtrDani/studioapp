...
@section('content')
<div class="mb-3">
    <form method="GET" action="{{ route('appointments') }}" class="form-inline">
        <div class="form-group mr-2">
            <label for="from_date" class="mr-2">De la:</label>
            <input type="date" name="from_date" id="from_date" class="form-control" value="{{ request('from_date') }}">
        </div>
        <div class="form-group mr-2">
            <label for="to_date" class="mr-2">Până la:</label>
            <input type="date" name="to_date" id="to_date" class="form-control" value="{{ request('to_date') }}">
        </div>
        <button type="submit" class="btn btn-primary">Filtrează</button>
        <a href="{{ route('appointments') }}" class="btn btn-secondary ml-2">Resetează</a>
    </form>
</div>
<!-- Modal -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm py-0 px-1 view-appointment-btn"
                                                    ...
                                                    data-id="{{ $appointment->id }}" data-name="{{ $appointment->name }}"
